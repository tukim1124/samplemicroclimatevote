...
public class SessionRatingListProvider implements MessageBodyReader<List<SessionRating>>, MessageBodyWriter<List<SessionRating>> {
    ...
    public long getSize(List<SessionRating> sessionRating, Class<?> clazz, Type type, Annotation[] annotations, MediaType mediaType) {
        if (isDebugEnabled())
            System.out.println("SRLP.getSize() clazz=" + clazz + " type=" + type + " annotations=" + annotations + " mediaType=" + mediaType);
        return 0;
    }
    ...
    public boolean isWriteable(Class<?> clazz, Type type, Annotation[] annotations, MediaType mediaType) {
        ...
        if (isDebugEnabled())
            System.out.println("SRLP.isWriteable() clazz=" + clazz + " type=" + type + " annotations=" + annotations + " mediaType=" + mediaType + " ==> " + isWriteable);
        return isWriteable;
    }
